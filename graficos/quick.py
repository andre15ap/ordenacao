...
class Main:
    def __init__(self):
        dataset = open('../saidas/quick_aleatorio.csv', 'r')
        x = []
        y = []
        for line in dataset:
            line.strip()
        ...
        dataset2 = open('../saidas/quick_inverso.csv', 'r')
        x = []
        y = []
        ...
        dataset3 = open('../saidas/quick_ordenado.csv', 'r')
        x = []
        y = []
        ...
        plt.title('Quick Sort com valores Ordenados, Aleatórios e Invertidos')
