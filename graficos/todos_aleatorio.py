...
class Main:
    def __init__(self):
        ...
        dataset2 = open('../saidas/insertion_aleatorio.csv', 'r')
        x = []
        y = []
        ...
        dataset3 = open('../saidas/merge_aleatorio.csv', 'r')
        x = []
        y = []
        ...
        dataset4 = open('../saidas/quick_aleatorio.csv', 'r')
        x = []
        y = []
        ...
        dataset5 = open('../saidas/selection_aleatorio.csv', 'r')
        x = []
        y = []
