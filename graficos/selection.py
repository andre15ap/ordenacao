...
class Main:
    def __init__(self):
        dataset = open('../saidas/selection_aleatorio.csv', 'r')
        x = []
        y = []
        for line in dataset:
            line.strip()
        ...
        dataset2 = open('../saidas/selection_inverso.csv', 'r')
        x = []
        y = []
        ...
        dataset3 = open('../saidas/selection_ordenado.csv', 'r')
        x = []
        y = []
        ...
        plt.title('Selection Sort com valores Ordenados, Aleatórios e Invertidos')
