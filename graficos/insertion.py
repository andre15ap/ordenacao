...
class Main:
    def __init__(self):
        dataset = open('../saidas/insertion_aleatorio.csv', 'r')
        x = []
        y = []
        for line in dataset:
            line.strip()
        ...
        dataset3 = open('../saidas/insertion_ordenado.csv', 'r')
        x = []
        y = []
        ...
        plt.title('Insertion Sort com valores Ordenados, Aleatórios e Invertidos')
