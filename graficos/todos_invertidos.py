...
class Main:
    def __init__(self):
        dataset = open('../saidas/buble_inverso.csv', 'r')
        x = []
        y = []
        for line in dataset:
            line.strip()
        ...
        dataset2 = open('../saidas/insertion_inverso.csv', 'r')
        x = []
        y = []
        ...
        dataset3 = open('../saidas/merge_inverso.csv', 'r')
        x = []
        y = []
        ...
        dataset4 = open('../saidas/quick_inverso.csv', 'r')
        x = []
        y = []
        ...
        dataset5 = open('../saidas/selection_inverso.csv', 'r')
        x = []
        y = []
        ...
        plt.title('Todos Ordenados Inversamente')
